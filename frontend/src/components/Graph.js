...
function Graph({ticker}) {
  ...
  useEffect( () => {
    ...
    axios.get(`https://finnhub.io/api/v1/stock/candle?symbol=${ticker}&resolution=60&from=1657692413&to=1657778813&token=cb6avbiad3i70tu62u4g`)
  ...
  return (
    <div style={{width: "40%", height: "2vh",position:"relative", marginBottom:"5%",}}> <Line options = {options} data = {data} /> </div>
  )
}
